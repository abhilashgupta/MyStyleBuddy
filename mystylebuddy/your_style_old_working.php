						...
						if($occasion=="casual"){
							...
							if($BT=="Fat" && $SC=="Fair")
							{
								if($Age=="16-20"){
									...
									$select_query="SELECT * FROM women_trousers where (occasion='$occasion') LIMIT 10";
									$query_db=mysql_query($select_query);
							...
							if($occasion=="formal"){
								...
								if($BT=="Fat" && $SC=="Dark")
								{
									...
									// 		$select_query="SELECT * FROM women_dresses where ((color='black' OR color='blue') ) LIMIT 10";
									// 		$query_db=mysql_query($select_query);
									...
									// 			echo $stringData;
									// 		}
									// 		$select_query="SELECT * FROM women_shorts_skirts where ((color='black' OR color='blue') ) LIMIT 10";
									// 		$query_db=mysql_query($select_query);
